...
imgs_torch1 = torch.tensor([[1.0,1.0, 1.0],[1.0,0.0, 0.2], [0.2,0.8, 0.2]]).unsqueeze(0).unsqueeze(0)
imgs_torch2 = torch.tensor([[1.0,1.0, 1.0],[0.6,0.0, 0.4], [0.2,0.8, 0.2]]).unsqueeze(0).unsqueeze(0)
print(imgs_torch1)
print(imgs_torch2)
